...
phage_hit_lengths.df <-
  read.csv("longest_phage_hits.csv")
...
gps.df <-
  read.csv("gps_info.csv")

phage_insertions.df <-
  read.csv(file = "Spn_att.csv") %>%
...
int.tree <-
  ape::read.tree("int_sequences.tree")
...
att_tree <- read.tree("central_att_sites.tree")
...
box.positions <-
  read.table(file = "R6_BOX_positions.list") %>% dplyr::pull()
...
ma_phage.df <-
  read.csv("prophage_regulatory_summary.csv") %>%
...
hmm_hits.df <-
  process_hmm_hits("gps_phage_domains.tab") %>%
    dplyr::mutate(
...
#                         identifier = "gene_id")
r6.granges.list<-gffRead("/Users/ncrouche/Documents/transformationMGE/prophage_deletion/figures/R6.gff",nrows = 2315)
...
scr.df <-
  read.csv(file = "Modified_scRNA_transformation_final_final_03052024.csv") %>%
...
att_srpRNA_growth.df <-
  get_growth_curve_df(read.csv("R6x_growth_repeat_titration.csv"))
...
phage_mutant_growth.df <-
  dplyr::bind_rows(
    get_growth_curve_df(read.csv("RMV8_growth_curves.csv")) %>%
      dplyr::mutate(phage = "phi*'RMV8'"),
    get_growth_curve_df(read.csv("2743_growth_curves.csv")) %>%
      dplyr::mutate(phage = "phi*'08B02743'"),
    get_growth_curve_df(read.csv("RMV4_phageKO_normal_growth_curve.csv")) %>%
...
deletions.df <-
  dplyr::bind_rows(
    read.csv("RMV8_rates_deletions.csv") %>%
      dplyr::mutate(phage = "phi*'RMV8'") %>%
    ...
    read.csv("2743_rates_deletions_raw.csv") %>%
      dplyr::mutate(phage = "phi*'08B02743'") %>%
    ...
    read.csv("RMV4_rates_deletions_raw.csv") %>%
      dplyr::mutate(phage = "phi*'RMV4'") %>%
      dplyr::rename(Rif.colonies = Rif.colonies,
                    Rif.volume = Volume,
                    Rif.per_1 = per_1,
                    ...
                    Kan.per_1 = per_1.1,
                    Deletion_ratio = Transformation.efficiency),
    read.csv("RMV8_Hybrid_int_rates_deletions.csv") %>%
    ...
    read.csv("2743_additional_deletions.csv") %>%
...
control_growth.df <-
  get_growth_curve_df(read.csv("RMV8_mutants_pro_ermB_control.csv"))
...
control_deletions.df <-
  read.csv("control_prophageKO.csv") %>%
...
active_pvrms_ratios.df <-
  read.csv("rates_of_deletion_Ion_Aug_2022.csv") %>%
...
pvrms_versions.df <-
  dplyr::bind_rows(
    read.csv("2743_tvrR_rates_deletions.csv") %>%
      dplyr::mutate(mutant = dplyr::case_when(
...
pv_rms_in_rmv.df <-
  dplyr::bind_rows(
    ...
    read.csv("RMV4_Ion_deletion_data.csv") %>%
      dplyr::mutate(mutant = dplyr::case_when(
          Genotype == "WT" ~ "WT",
          Genotype == "∆int" ~ "int",
    ...
    read.csv("RMV8_Ion_deletion_data.csv") %>%
      dplyr::mutate(mutant = dplyr::case_when(
          Genotype == "WT" ~ "WT",
...
insertion.df <-
  read.csv("RMV8_prophage_insertion_RAW_DATA.csv") %>%
...
rmv4_overnight_excision_df <-
  dplyr::bind_rows(
    read.csv("22072024_Overnight_0.2_20hr_RMV4.csv")
  ) %>%
  dplyr::mutate(Condition = dplyr::case_when(
      grepl("CSP",mutants) ~ "CSP",
...
activation.df <-
  dplyr::bind_rows(
    read.csv("RMV8_col4_ADbyAB_phage_Hybrid_July_v2.csv") %>%
      dplyr::rename(ratio = ADbyAB),
    read.csv("2743_ADAB_overnights.csv"),
    read.csv("RMV4_ADbyAB_overnights.csv"),
    read.csv("overnight_ADbyAB.csv") %>%
    ...
    read.csv("Overnight_CSP_18hr.csv") %>%
      ...
      dplyr::rename(ratio = ADbyAB),
    # Extra replicates
    read.csv("Overnight_AdbyAB_extra_July.csv") %>%
      dplyr::rename(ratio = ADbyAB),
    read.csv("Overnight_RMV8_ADbyAB.csv") %>%
      dplyr::rename(ratio = ADbyAB),
    read.csv("Overnight_extra_ADbyAB_August.csv") %>%
      dplyr::rename(ratio = ADbyAB)
  ) %>%
  dplyr::rename(Genotype = mutants) %>%
  dplyr::mutate(phage = dplyr::case_when(
...
phi_rmv8_growth.df <-
  get_growth_curve_df(purrr::map(list(
                                  "1207_withoutMitomycin_RMV8.csv",
                                  "1207_withMitomycin_RMV8.csv",
                                  "1207_withoutMitomycin_RMV8_PhageKO.csv",
                                  "1207_withMitomycin_RMV8_PhageKO.csv",
                                  "1807_RMV8_recAKO_without_mitomycin.csv",
                                  "1807_RMV8_recAKO_with_mitomycin.csv",
                                  "1807_RMV8_phageKO_recAKO_without_mitomycin.csv",
                                  "1807_RMV8_phageKO_recAKO_with_mitomycin.csv"
                                ),
                               read.csv) %>%
...
phi_rmv8_hybrid_growth.df <-
  get_growth_curve_df(purrr::map(list(
                                  "1207_withMitomycin_Hybrid_RMV8.csv",
                                  "1207_withoutMitomycin_Hybrid_RMV8.csv"
                                ),
                               read.csv) %>%
                      purrr::reduce(left_join, by = "OD600"),
    threshold = 7.5
...
phi_08B02743_hybrid_growth.df <-
  get_growth_curve_df(dplyr::left_join(read.csv("2743_CSP_Mitomycin_DNA.csv"),
                                     read.csv("2743_prophageKO_CSP_Mitomycin_DNA.csv"),
                                     by = c("OD600")) %>%
                      dplyr::left_join(read.csv("2743_recAKO_CSP_Mitomycin_DNA.csv")),
    threshold = 7.5
  ) %>%
  dplyr::mutate(phage = "phi*'08B02743'") %>%
...
phi_rmv8_and_hybrid_with_mmc.df <-
  get_growth_curve_df(read.csv("2nd_replicate_RMV8.csv"),
    threshold = 7.5) %>%
...
phi_rmv8_and_hybrid_with_without_mmc.df <-
  get_growth_curve_df(read.csv("3rd_replicate_RMV8.csv"),
    threshold = 7.5) %>%
...
phi_rmv4_and_hybrid_with_without_mmc.df <-
  get_growth_curve_df(read.csv("RMV4_mitomycin_CSP_GD_growth.csv"),
    threshold = 7.5) %>%
  dplyr::mutate(phage = dplyr::case_when(
...
phi_rmv8_and_hybrid_with_without_mmc_replicate_2.df <-
  get_growth_curve_df(read.csv("growth_fifth_replicate.csv"),
    threshold = 7.5) %>%
  dplyr::mutate(phage = dplyr::case_when(
...
additional_exposure_replicates.df <-
  dplyr::bind_rows(
    get_growth_curve_df(read.csv("2743_two_replicate_MMC_GD.csv") %>% 
      ...
      rename_with(~ stringr::str_replace(.x, 
        ...
        threshold = 7.5) %>%
      dplyr::mutate(phage = "phi*'08B02743'"),
    get_growth_curve_df(read.csv("RMV4_two_replicate_MMC_GD.csv") %>% 
      rename_with(~ stringr::str_replace(.x, 
                                         pattern = "control", 
                                         replacement = "RMV4"),
                  matches("control")) %>%
      rename_with(~ stringr::str_replace(.x, 
        ...
        threshold = 7.5) %>%
      dplyr::mutate(phage = "phi*RMV4'"),
    get_growth_curve_df(read.csv("RMV8_two_replicate_MMC_GD.csv") %>% 
      rename_with(~ stringr::str_replace(.x, 
                                         pattern = "control", 
                                         replacement = "RMV8"),
                  matches("control")) %>%
...
rmv8_hybrid_iptg_growth.df <-
  dplyr::bind_rows(
    get_growth_curve_df(read.csv("RMV8_plac_recA_growth_GD_MMC.csv"), threshold = time_threshold) %>%
      dplyr::mutate(Genotype = "phi*'RMV8'~italic(recA)[italic(lacI)]"),
    get_growth_curve_df(read.csv("RMV8_Hybrid_HF_plac_recA_growth_GD_MMC.csv"), threshold = time_threshold) %>%
...
partial_deletions.df <-
  dplyr::bind_rows(
    read.csv("2743_partial_using_GD_July.csv") %>%
      dplyr::mutate(phage = "phi*'08B02743'",
                    Genotype = "08B02743",
                    conditions = "gDNA"),
    read.csv("2743_partial_using_PCR.csv") %>%
      dplyr::mutate(phage = "phi*'08B02743'",
                    Genotype = "08B02743") %>%
      dplyr::rename(conditions = condition),
    read.csv("RMV8_partial_deletions_usingPCR_July_v3.csv") %>%
      dplyr::mutate(phage = "phi*'RMV8'",
                    Genotype = "RMV8"),
    read.csv("RMV8_deletions_usingGD_July.csv") %>%
      dplyr::mutate(phage = "phi*'RMV8'",
                    Genotype = "RMV8",
                    conditions = "gDNA"),
    read.csv("RMV8_hybrid_partial_deletions_usingPCR_July_v3.csv") %>%
      dplyr::mutate(phage = "phi*'RMV8'[italic(immARcat)]",
                    Genotype = "RMV8_Znregcat"),
    read.csv("RMV8_hybrid_partial_usingGD_July_v3.csv") %>%
      dplyr::mutate(phage = "phi*'RMV8'[italic(immARcat)]",
                    Genotype = "RMV8_Znregcat",
                    conditions = "gDNA"),
    
        read.csv("RMV4_partial_PCR_Partial_deletions.csv") %>%
      dplyr::mutate(phage = "phi*'RMV4'",
                    Genotype = "RMV4") %>%
      dplyr::rename(conditions = condition),
    
        read.csv("RMV4_partial_deletions_usingGD.csv") %>%
      dplyr::mutate(phage = "phi*'RMV4'",
                    Genotype = "RMV4",
                    conditions = "gDNA"),
...
rmv8_comEA_growth.df <-
  dplyr::bind_rows(
    get_growth_curve_df(read.csv("RMV8_metals.csv")) %>%
      dplyr::mutate(Genotype = '""~phi*"RMV8"~""'),
    get_growth_curve_df(read.csv("RMV8_comEA_metals_senstivity_2_replicates.csv")) %>%
...
dprA_comparison.df <-
  dplyr::bind_rows(
    ...
    get_growth_curve_df(read.csv("RMV8_metals_dprAKO.csv")) %>%
...
dprA_double_mutants.df <-
  dplyr::bind_rows(
    ...
    # REMOVE
    get_growth_curve_df(read.csv("2743_prophageJan_dprAcat_2604.csv")) %>%
...
check_2743.df <-
  get_growth_curve_df(read.csv("2743_zn_mutants_all_mitomycin_senstivity_repeat.csv")) %>%
    dplyr::mutate(Genotype = dplyr::case_when(
...
phage_excision.df <-
  dplyr::bind_rows(
    ...
    # AD to AB ratio
    read_excision_file("2743_ADbyAB_1st_2nd_3rd.csv") %>%
      dplyr::mutate(phage = "08B02743") %>%
      dplyr::rename(ratio = ADbyAB) %>%
      dplyr::mutate(Measurement = "AD to AB ratio"),
   read_excision_file("ADbyAB_RMV8_1st_2nd_3rd.csv") %>%
      dplyr::mutate(phage = "RMV8") %>%
      dplyr::rename(ratio = ADbyAB) %>%
      dplyr::mutate(Measurement = "AD to AB ratio"),
   read_excision_file("ADbyAB_RMV8_hybrid_1st_2nd_3rd.csv") %>%
      dplyr::rename(ratio = ADbyAB) %>%
      dplyr::mutate(phage = "RMV8_hybrid") %>%
      dplyr::mutate(Measurement = "AD to AB ratio"),
   read_excision_file("RMV4_ADbyAB_1st_2nd_3rd.csv") %>%
      dplyr::mutate(phage = "RMV4") %>%
      dplyr::mutate(Measurement = "AD to AB ratio"),
   
   # BC to rpoA ratio
    read_excision_file("2743_BC_1st_2nd_3rd.csv") %>%
      dplyr::mutate(phage = "08B02743") %>%
      dplyr::mutate(Measurement = "BC total"),
   read_excision_file("RMV8_circular_1st_2nd_3rd.csv") %>%
      dplyr::mutate(phage = "RMV8") %>%
      dplyr::mutate(Measurement = "BC total"),
   read_excision_file("RMV8_hybrid_circular_1st_2nd_3rd.csv") %>%
      dplyr::mutate(phage = "RMV8_hybrid") %>%
      dplyr::mutate(Measurement = "BC total"),
   read_excision_file("RMV4_BC_1st_2nd_3rd.csv") %>%
      dplyr::mutate(phage = "RMV4") %>%
      dplyr::mutate(Measurement = "BC total"),
   
   # Extracellular BC to rpoA ratio
   dplyr::bind_cols(
     read_excision_file("2743_RMV4_filtered_extra_ratio_with_Time0_v2.csv"),
     read.csv("2743_RMV4_filtered_extra_ratio_with_Time0_v2.csv") %>%
     dplyr::mutate(phage = dplyr::if_else(grepl("RMV4",mutants),"RMV4","08B02743")) %>%
     dplyr::select(phage)
   ) %>%
   dplyr::mutate(Measurement = "BC extracellular"),
   dplyr::bind_cols(
     read_excision_file("RMV8_RMV8_hybrid_filtered_extra_ratio_Time0_v2.csv"),
     read.csv("RMV8_RMV8_hybrid_filtered_extra_ratio_Time0_v2.csv") %>%
...
phage_transcription.df <-
  dplyr::bind_rows(
    read_expression_file("2743_prophage_induction_1st_2nd_3rd.csv") %>%
      dplyr::mutate(phage = "08B02743"),
    read_expression_file("RMV4_prophage_induction_1st_2nd_3rd.csv") %>%
      dplyr::mutate(phage = "RMV4"),
   read_expression_file("RMV8_prophage_induction_1st_2nd_3rd.csv") %>%
      dplyr::mutate(phage = "RMV8"),
   read_expression_file("RMV8_hybrid_prophage_induction_1st_2nd_3rd.csv") %>%
      dplyr::mutate(phage = "RMV8_hybrid")
  ) %>%
...
prophage_excision_summary_plot <-
  magick::image_ggplot(image_crop(image_trim((image_read_pdf("prophage_excision_summary_figure.pdf")))))
...
rmv8_hyrbid_recA_effect.df <-
  dplyr::bind_rows(
    read_expression_file("RMV8_recAKO_phage_induction_3replicates.csv") %>% 
      dplyr::mutate(RecA = "italic(recA)~'negative'",
                    phage = "phi*'RMV8'"),
    read_expression_file("04032024_RMV8_4th_replicate.csv") %>%
      dplyr::mutate(RecA = "italic(recA)~'negative'",
                    phage = "phi*'RMV8'"),
    read_expression_file("Hybrid_recAKO_induction_3_replicates.csv") %>% 
      dplyr::mutate(RecA = "italic(recA)~'negative'",
...
recA_standardised_wt.df <-
  dplyr::bind_rows(
    read_expression_file("RMV8_recA_comapred_RMV8_T0_3replicates.csv") %>%
      dplyr::mutate(RecA = "italic(recA)~'negative'",
                    base_phage = "RMV8",
                    phage = "phi*'RMV8'~italic(recA)*'::Janus'"),
    read_expression_file("RMV8_4th_replicate_normliased_to_WT_T0.csv") %>%
      dplyr::mutate(RecA = "italic(recA)~'negative'",
                    base_phage = "RMV8",
                    phage = "phi*'RMV8'~italic(recA)*'::Janus'"),
    read_expression_file("RMV8_hybrid_recA_normliased_RMV8hybrid_T0_three_replicates.csv") %>%
      dplyr::mutate(RecA = "italic(recA)~'negative'",
...
comEA_phage_expression.df <-
  read_expression_file("RMV8_comEAKO_phage_induction_three_replicates.csv") %>%
  dplyr::mutate(Time = factor(Time, levels = c("0","20","60","120")),
                Condition = factor(Condition, levels = c("No supplement","CSP","Mitomycin C"))) %>%
...
rmv8_comEA.df <-
  dplyr::bind_rows(
    read_excision_file("comEA_cat_extracellular_BCbyrpoAthree_replicates.csv") %>%
      dplyr::mutate(Measurement = "BC extracellular") %>%
      dplyr::rename(value = Extracellular_BC),
    read_excision_file("comEA_mutants_ADbyAB_three_replicates_July.csv") %>%
      dplyr::mutate(Measurement = "AD to AB ratio") %>%
      dplyr::rename(value = ADbyAB),
    read_excision_file("comEA_mutants_BCbyRpoA_three_replicates_July.csv") %>%
      dplyr::mutate(Measurement = "BC total") %>%
...
in_situ.df <-
  dplyr::bind_rows(
    read_excision_file("RMV8_repbyrpoA_1st2nd.csv") %>%
      dplyr::mutate(Genotype = "phi*'RMV8'"),
    read_excision_file("RMV8_intcat_repbyrpoA_1st2nd.csv")  %>%
...
in_situ_int_mutant.df <-
  read.csv("RMV8_Hybrid_intcat_2hour_4hour_repbyrpoA.csv") %>%
...
dprA_standardised_wt.df <-
  dplyr::bind_rows(
    read_expression_file("2743_dprA_competence_transcriptions.csv") %>%
      dplyr::mutate(Genotype = "atop(phi*'08B02743',italic(dprA)*'::Janus')"),
    read_expression_file("2743_dprA_transcription_two_replicates.csv") %>%
...
dprA_standardised_wt.df %<>%
  dplyr::bind_rows(
    phage_transcription.df %>%
      ...
      dplyr::mutate(Genotype = "phi*'08B02743'"),
    read_expression_file("2743_comEA_foldchange.csv") %>%
      dplyr::mutate(phage = "phi*'08B02743'",
...
phage_excision_dprA.df <-
  dplyr::bind_rows(
    ...
    read_dprA_excision_file("2743_dprA_extracellular_1706.csv") %>%
      dplyr::mutate(Measurement = "BC extracellular",
    ...
    read_dprA_excision_file("2743_dprA_zncat_extracellular_1706.csv") %>%
      dplyr::mutate(Measurement = "BC extracellular",
    ...
    # WT - intracellular
    read_dprA_excision_file("2743_dprA_intracellular_BC_1706.csv") %>%
      dplyr::mutate(Measurement = "BC total",
                    Genotype = "atop(phi*'08B02743',italic(dprA)*'::Janus')",
                    phage = "phi*'08B02743'"
                    ) %>%
    ...
    read_dprA_excision_file("2743_zncat_dprA_BC_intracellular_1706.csv") %>%
      dplyr::mutate(Measurement = "BC total",
                    Genotype = "atop(phi*'08B02743'~italic(szaL)*'::'*italic(cat),italic(dprA)*'::Janus')",
                    phage = "phi*'08B02743'~italic(szaL)*'::'*italic(cat)"
                    ) %>%
    ...
    # zncat extracellular
    read_dprA_excision_file("2743_zncat_extracellular_BC.csv") %>%
      dplyr::mutate(Measurement = "BC extracellular",
      ...
      dplyr::rename(value = BCbyRpoA),
    # zncat total
    read_dprA_excision_file("2743_zncat_intracellular_BC.csv") %>%
      dplyr::mutate(Measurement = "BC total",
                    Genotype = "atop(phi*'08B02743',italic(szaL)*'::'*italic(cat))",
                    phage = "phi*'08B02743'~italic(szaL)*'::'*italic(cat)"
                    ) %>%
    ...
    read_dprA_excision_file("recA_KO_extracellular_DNA_three.csv") %>%
      dplyr::mutate(Measurement = "BC extracellular",
    ...
    read_dprA_excision_file("2743_recA_intracellular_BC_three_replicates.csv") %>%
      dplyr::mutate(Measurement = "BC total",
                    Genotype = "atop(phi*'08B02743',italic(recA)*'::Janus')",
                    phage = "phi*'08B02743'"
                    ) %>%
    ...
    read_dprA_excision_file("2743_zncat_recA_intracellular_BC.csv") %>%
      dplyr::mutate(Measurement = "BC total",
    ...
    read_dprA_excision_file("2743_zncat_recA_extracellular_BC.csv") %>%
      dplyr::mutate(Measurement = "BC extracellular",
                    Genotype = "atop(phi*'08B02743'~italic(szaL)*'::'*italic(cat),italic(recA)*'::Janus')",
                    phage = "phi*'08B02743'~italic(szaL)*'::'*italic(cat)"
                    ) %>%
    ...
    # 2743 RecA excision
    read_dprA_excision_file("2743_recA_ADbyAB_two.csv") %>%
      dplyr::mutate(Measurement = "AD to AB ratio",
                    Genotype = "atop(phi*'08B02743',italic(recA)*'::Janus')",
                    phage = "phi*'08B02743'"
                    ) %>%
    ...
    # 2743 DprA excision
    read_dprA_excision_file("2743_dprA_ADbyAB_two_replicates.csv") %>%
      dplyr::mutate(Measurement = "AD to AB ratio",
                    Genotype = "atop(phi*'08B02743',italic(dprA)*'::Janus')",
                    phage = "phi*'08B02743'",
    ...
    # 2743 zncat excision
    read_dprA_excision_file("2743_zncat_ADbyAB_three.csv") %>%
      dplyr::mutate(Measurement = "AD to AB ratio",
                    Genotype = "atop(phi*'08B02743',italic(szaL)*'::'*italic(cat))",
                    phage = "phi*'08B02743'~italic(szaL)*'::'*italic(cat)"
                    ) %>%
    ...
    read_dprA_excision_file("2743_zncat_dprA_two_ADbyAB.csv") %>%
      dplyr::mutate(Measurement = "AD to AB ratio",
                    Genotype = "atop(phi*'08B02743'~italic(szaL)*'::'*italic(cat),italic(dprA)*'::Janus')",
                    phage = "phi*'08B02743'~italic(szaL)*'::'*italic(cat)"
                    ) %>%
    ...
    read_dprA_excision_file("2743_zncat_recA_ADbyAB_two.csv") %>%
      dplyr::mutate(Measurement = "AD to AB ratio",
                    Genotype = "atop(phi*'08B02743'~italic(szaL)*'::'*italic(cat),italic(recA)*'::Janus')",
                    phage = "phi*'08B02743'~italic(szaL)*'::'*italic(cat)"
                    ) %>%
...
phage_excision_spaL.df <-
  dplyr::bind_rows(
    ...
    dplyr::bind_rows(
      # Excision
      read_dprA_excision_file("RMV4_spaL_ADbyAB_three_replicates.csv") %>%
        dplyr::mutate(Measurement = "AD to AB ratio",
        ...
        dplyr::rename(value = ADbyAB),
      # Extracellular
      read_dprA_excision_file("RMV4_spaL_extracellular_BC_three_replicates.csv") %>%
        dplyr::mutate(Measurement = "BC extracellular",
                      Genotype = "phi*'RMV4'~italic(spaL)*'::'*italic(cat)",
                      phage = "phi*'RMV4'~italic(spaL)*'::'*italic(cat)"
                      ) %>%
        dplyr::rename(value = BCbyRpoA),
      # Total
      read_dprA_excision_file("RMV4_spaL_intracellular_BC_three_replicates.csv") %>%
        dplyr::mutate(Measurement = "BC total",
                      Genotype = "phi*'RMV4'~italic(spaL)*'::'*italic(cat)",
                      phage = "phi*'RMV4'~italic(spaL)*'::'*italic(cat)"
                      ) %>%
        dplyr::rename(value = BCbyRpoA),
      # DprA
      read_dprA_excision_file("RMV4_dprA_induction_ADbyAB.csv") %>%
      dplyr::mutate(Measurement = "AD to AB ratio",
                    Genotype = "phi*'RMV4'~italic(dprA)*'::Janus'",
                    phage = "phi*'RMV4'~italic(dprA)*'::Janus'"
                    ) %>%
            dplyr::rename(value = ADbyAB),
      read_dprA_excision_file("RMV4_dprA_intracellular_BCbyRpoA_two_replicates.csv") %>%
      dplyr::mutate(Measurement = "BC total",
                    Genotype = "phi*'RMV4'~italic(dprA)*'::Janus'",
                    phage = "phi*'RMV4'~italic(dprA)*'::Janus'"
                    ) %>%
            dplyr::rename(value = BCbyRpoA),
      read_dprA_excision_file("RMV4_dprA_extracellular_BCbyRpoA_two_replicates.csv") %>%
      dplyr::mutate(Measurement = "BC extracellular",
                    Genotype = "phi*'RMV4'~italic(dprA)*'::Janus'",
                    phage = "phi*'RMV4'~italic(dprA)*'::Janus'"
                    ) %>%
...
deletion_kinetics.df <-
  read.csv("prophage_deletion_over_time.csv") %>%
...
iptg_induction.df <-
  dplyr::bind_rows(
    # RMV8
    get_growth_curve_df(read.csv("RMV8_pLac_recA.csv") %>%
                          dplyr::rename_with(
    ...
    # RMV8 hybrid
    get_growth_curve_df(read.csv("MMC_IPTG_RMV8_hybrid_plac_recA.csv") %>%
                          dplyr::rename_with(
...
iptg_phage_expression_df <-
  read.csv("IPTG_recA_indcued_RMV8vsHybrid.csv") %>%
    dplyr::mutate(Time = dplyr::case_when(
            grepl("T0_",mutants) ~ "0",
            grepl("_T0",mutants) ~ "0",
            grepl("T20_",mutants) ~ "20",
...
iptg_validation.df <-
  read.csv("IPTG_recA_Inudction_final.csv") %>%
...
iptg_half_mmc_induction.df <-
  dplyr::bind_rows(
    # RMV8
    get_growth_curve_df(read.csv("halfMMC_RMV8.csv") %>%
                          dplyr::rename_with(
                            ~ gsub("_\\.",".",gsub("_$","",paste0("RMV8_", gsub("control","",.x), recycle0 = TRUE))),
                            !starts_with("OD600")
                          )
      ...
      dplyr::mutate(phage = "phi*'RMV8'"),
    # RMV8 pLac mutant 1
    get_growth_curve_df(read.csv("halfMMC_RMV8_DT3_plac_recA.csv") %>%
                          dplyr::rename_with(
                            ~ gsub("_\\.",".",gsub("_$","",paste0("RMV8_hybrid_", gsub("control","",.x), recycle0 = TRUE))),
                            !starts_with("OD600")
                          )
      ...
      dplyr::mutate(phage = "phi*'RMV8'"),
    # RMV8 hybrid
    get_growth_curve_df(read.csv("halfMMC_hybrid.csv") %>%
                          dplyr::rename_with(
                            ~ gsub("_\\.",".",gsub("_$","",paste0("RMV8_hybrid_", gsub("control","",.x), recycle0 = TRUE))),
                            !starts_with("OD600")
                          )
    ...
    get_growth_curve_df(read.csv("halfMMC_hybrid_DT1_plac_recA.csv") %>%
                          dplyr::rename_with(
                            ~ gsub("_\\.",".",gsub("_$","",paste0("RMV8_hybrid_", gsub("control","",.x), recycle0 = TRUE))),
                            !starts_with("OD600")
                          )
...
raw_growth_comparison_induction.df <-
  dplyr::bind_rows(
    # RMV4
    get_growth_curve_df(read.csv("RMV4_metals.csv")) %>%
      dplyr::mutate(Genotype = "'RMV4'") %>%
      dplyr::mutate(phage = "phi*'RMV4'") %>%
      dplyr::mutate(Background = "'Wild type'"),
    get_growth_curve_df(read.csv("RMV4_prophage_metals.csv")) %>%
      dplyr::mutate(Genotype = "'RMV4'") %>%
      dplyr::mutate(phage = "phi*'RMV4'") %>%
      dplyr::mutate(Background = "'prophage::Janus'") %>%
      dplyr::filter(`Growth condition` != "Mitomycin C"),
    # Re-run of MMC
    get_growth_curve_df(read.csv("RMV4-prophageKO.csv")) %>%
      dplyr::mutate(Genotype = "'RMV4'") %>%
      dplyr::mutate(phage = "phi*'RMV4'") %>%
      dplyr::mutate(Background = "'prophage::Janus_rerun'"),
    get_growth_curve_df(read.csv("RMV4_recAKO_metals_2nd.csv")) %>%
      dplyr::mutate(phage = "phi*'RMV4'",
                    Genotype = "'RMV4'",
    ...
    get_growth_curve_df(read.csv("RMV8_metals.csv")) %>%
      ...
      dplyr::mutate(phage = "phi*'RMV8'") %>%
      dplyr::mutate(Background = "'Wild type'"),
    get_growth_curve_df(read.csv("RMV8_recAKO_metals.csv")) %>%
      dplyr::mutate(Genotype = "'RMV8'") %>%
      dplyr::mutate(phage = "phi*'RMV8'") %>%
      dplyr::mutate(Background = "italic(recA)*'::Janus'"),
    get_growth_curve_df(read.csv("RMV8_prophageKO_metals.csv")) %>%
      dplyr::mutate(Genotype = "'RMV8'") %>%
      dplyr::mutate(phage = "phi*'RMV8'") %>%
      dplyr::mutate(Background = "'prophage::Janus'"),
    # 2743
    get_growth_curve_df(read.csv("2743_metals_1st.csv")) %>%
      dplyr::mutate(Genotype = "'08B02743'") %>%
      dplyr::mutate(phage = "phi*'08B02743'") %>%
      dplyr::mutate(Background = "'Wild type'"),
    get_growth_curve_df(read.csv("2743_recA_metals_test.csv")) %>%
      dplyr::mutate(Genotype = "'08B02743'") %>%
      dplyr::mutate(phage = "phi*'08B02743'") %>%
      dplyr::mutate(Background = "italic(recA)*'::Janus'"),
    get_growth_curve_df(read.csv("2743_prophageKO_metals.csv")) %>%
      dplyr::mutate(Genotype = "'08B02743'") %>%
      dplyr::mutate(phage = "phi*'08B02743'") %>%
      dplyr::mutate(Background = "'prophage::Janus'"),
    # RMV8 hybrid
    get_growth_curve_df(read.csv("RMV8_hybrid_metals.csv")) %>%
      dplyr::mutate(Genotype = "'RMV8_Znregcat'") %>%
      dplyr::mutate(phage = "phi*'RMV8'[italic(immARcat)]") %>%
      dplyr::mutate(Background = "'Wild type'"),
    get_growth_curve_df(read.csv("RMV8_hybrid_recAKO_metals.csv")) %>%
      dplyr::mutate(Genotype = "'RMV8_Znregcat'") %>%
      dplyr::mutate(phage = "phi*'RMV8'[italic(immARcat)]") %>%
      dplyr::mutate(Background = "italic(recA)*'::Janus'"),
    get_growth_curve_df(read.csv("29022024_2743_sc1.csv")) %>%
      dplyr::mutate(Background = "'Wild type'") %>%
      dplyr::mutate(phage = "phi*'08B02743_MMC_repeat'") %>%
      dplyr::mutate(Genotype = "'08B02743'"),
    get_growth_curve_df(read.csv("29022024_2743_R1_RecA.csv")) %>%
      dplyr::mutate(Background = "italic(recA)*'::Janus'") %>%
      dplyr::mutate(phage = "phi*'08B02743_MMC_repeat'") %>%
      dplyr::mutate(Genotype = "'08B02743'")
  )
...
stimuli_mutants_raw_growth.df <-
  dplyr::bind_rows(
    # immA KO
    get_growth_curve_df(read.csv("2743_immAKO_metals.csv")) %>%
      dplyr::mutate(Background = "italic(immA)*'::'*italic(cat)") %>%
      dplyr::mutate(phage = "phi*'08B02743'") %>%
      dplyr::mutate(Genotype = "'08B02743'"),
    # rep KO
    get_growth_curve_df(read.csv("2743_repKO_metals.csv")) %>%
      dplyr::mutate(Background = "italic(rep)*'::'*italic(cat)") %>%
      dplyr::mutate(phage = "phi*'08B02743'") %>%
      dplyr::mutate(Genotype = "'08B02743'"),
    get_growth_curve_df(read.csv("RMV8_repKO_growth_metals.csv")) %>%
      dplyr::mutate(Background = "italic(rep)*'::'*italic(cat)") %>%
      dplyr::mutate(phage = "phi*'RMV8'") %>%
      dplyr::mutate(Genotype = "'RMV8'"),
    get_growth_curve_df(read.csv("RMV4_repKO_metals.csv")) %>%
      dplyr::mutate(Background = "italic(rep)*'::'*italic(cat)") %>%
      dplyr::mutate(phage = "phi*'RMV4'") %>%
      dplyr::mutate(Genotype = "'RMV4'"),
    # int KO
    get_growth_curve_df(read.csv("2743_intKO_metals.csv")) %>%
      dplyr::mutate(Background = "italic(int)*'::'*italic(cat)") %>%
      dplyr::mutate(phage = "phi*'08B02743'") %>%
      dplyr::mutate(Genotype = "'08B02743'"),
    get_growth_curve_df(read.csv("RMV8_intKO_growth_metals.csv")) %>%
      dplyr::mutate(Background = "italic(int)*'::'*italic(cat)") %>%
      dplyr::mutate(phage = "phi*'RMV8'") %>%
      dplyr::mutate(Genotype = "'RMV8'"),
    get_growth_curve_df(read.csv("RMV4_intcat_metals.csv")) %>%
      dplyr::mutate(Background = "italic(int)*'::'*italic(cat)") %>%
      dplyr::mutate(phage = "phi*'RMV4'") %>%
      dplyr::mutate(Genotype = "'RMV4'"),
    # lyt KO
    get_growth_curve_df(read.csv("2743_lytAKO_metals.csv")) %>%
      dplyr::mutate(Background = "italic(lyt)*'::'*italic(cat)") %>%
      dplyr::mutate(phage = "phi*'08B02743'") %>%
      dplyr::mutate(Genotype = "'08B02743'"),
    get_growth_curve_df(read.csv("RMV8_lytAKO_growth_2_metals.csv")) %>%
      dplyr::mutate(Background = "italic(lyt)*'::'*italic(cat)") %>%
      dplyr::mutate(phage = "phi*'RMV8'") %>%
      dplyr::mutate(Genotype = "'RMV8'"),
    get_growth_curve_df(read.csv("RMV4_lytKO_metals.csv")) %>%
      dplyr::mutate(Background = "italic(lyt)*'::'*italic(cat)") %>%
      dplyr::mutate(phage = "phi*'RMV4'") %>%
      dplyr::mutate(Genotype = "'RMV4'")
  )
...
immA_df <-
  dplyr::bind_rows(
      ...
      get_growth_curve_df(read.csv("2743_immA_dprA_022024.csv")) %>%
            dplyr::mutate(Genotype = '""~phi*"08B02743"~italic(dprA)*"::Janus"~italic(immA)*"::"*italic(cat)~""',
                          Background = "italic(recA)^'+'~italic(dprA)^'-'"),
      get_growth_curve_df(read.csv("2743_immA_recA_metals_growth.csv")) %>%
  ...
  dplyr::bind_rows(
    ...
    growth_comparison_induction.df %>%
      ...
      dplyr::mutate(Background = dplyr::if_else(Background == "'Wild type'",
                                                ...
                                                "italic(recA)^'-'~italic(dprA)^'+'")),
    get_growth_curve_df(read.csv("2743_zncat_metals.csv")) %>%
    ...
    get_growth_curve_df(read.csv("2743_zncat_recAKO_metals.csv")) %>%
      dplyr::mutate(Genotype = "'08B02743 szaL::cat'") %>%
      dplyr::mutate(phage = "atop(phi*'08B02743',italic(szaL)*'::'*italic(cat))") %>%
      dplyr::mutate(Background = "italic(recA)^'-'~italic(dprA)^'+'"),
    
    get_growth_curve_df(read.csv("04032024_2743_dprA_1st.csv") %>% dplyr::select(!dplyr::contains('_twice'))) %>%
      dplyr::mutate(Genotype = "'08B02743'") %>%
      dplyr::mutate(phage = "phi*'08B02743'") %>%
      dplyr::mutate(Background = "italic(recA)^'+'~italic(dprA)^'-'"),
    
    get_growth_curve_df(read.csv("04032024_2743_dprA_zncat_2nd.csv") %>% dplyr::select(!dplyr::contains('_twice'))) %>%
      dplyr::mutate(Genotype = "'08B02743 szaL::cat'") %>%
      dplyr::mutate(phage = "atop(phi*'08B02743',italic(szaL)*'::'*italic(cat))") %>%
      dplyr::mutate(Background = "italic(recA)^'+'~italic(dprA)^'-'")
...
szaL_expression_comparison_df <-
  read_expression_file("2743vs2743zncat_lytA_rep_T120_August.csv") %>%
      dplyr::rename(Fold_change = fold_change_MMC) %>%
  dplyr::mutate(Time = factor(Time, levels = c("0","20","60","120")),
                Condition = factor(Condition, levels = c("No supplement","CSP","Mitomycin C"))) %>%
  dplyr::mutate(Genotype = dplyr::if_else(
                      grepl("_zncat_",read.csv("2743vs2743zncat_lytA_rep_T120_August.csv",header=TRUE) %>%
                      dplyr::select(mutants) %>%
                      dplyr::pull()),
                      "phi*'08B02743'",
                      "atop(phi*'08B02743',italic(szaL)*'::'*italic(cat))"
...
szaL_effect_on_com_df <-
  dplyr::bind_rows(
    read_dprA_excision_file("RMV8_comX_transcriptions.csv"),
    read_dprA_excision_file("2743vs2743zncat_comX.csv"),
    read_dprA_excision_file("RMV8vsRMV8hybrid_recA_transcriptions.csv"),
    read_dprA_excision_file("2743vs_2743zncat_recA_transcirptions.csv")
  ) %>%
  dplyr::mutate(
    Genotype = 
      dplyr::case_when(
...
spaL_growth.df <-
  dplyr::bind_rows(
    ...
    get_growth_curve_df(read.csv("RMV4_spaL_repeat_metals.csv")) %>%
      dplyr::mutate(Genotype = "phi*'RMV4 spaL::cat'") %>%
      dplyr::mutate(Background = "italic(recA)^'+'~italic(dprA)^'+'") %>%
      dplyr::mutate(phage = 'phi*"RMV4"~italic(spaL)*"::"*italic(cat)'),
    get_growth_curve_df(read.csv("RMV4_spaL_recA_repeat.csv")) %>%
      dplyr::mutate(Genotype = "'RMV4 spaL::cat'") %>%
      dplyr::mutate(phage = 'phi*"RMV4"~italic(spaL)*"::"*italic(cat)') %>%
      dplyr::mutate(Background = "italic(recA)^'-'~italic(dprA)^'+'"),
    
    #get_growth_curve_df(read.csv("RMV4_metals_dprAKO.csv")) %>%
    get_growth_curve_df(read.csv("RMV4_1st_dprA_repeat_July_2024.csv")) %>%
      dplyr::mutate(Genotype = "'RMV4'") %>%
      dplyr::mutate(phage = "phi*'RMV4'") %>%
      dplyr::mutate(Background = "italic(recA)^'+'~italic(dprA)^'-'"),
    
    get_growth_curve_df(read.csv("RMV4_spaL_dprA_metals.csv")) %>%
      dplyr::mutate(Genotype = "'RMV4 spaL::cat'") %>%
      dplyr::mutate(phage = 'phi*"RMV4"~italic(spaL)*"::"*italic(cat)') %>%
      dplyr::mutate(Background = "italic(recA)^'+'~italic(dprA)^'-'")
...
RMV4_expression_df <-
  dplyr::bind_rows(
    ...
    read_expression_file("RMV4_spaL_transcriptions_All.csv") %>%
...
rates_of_activation.df <-
  dplyr::bind_rows(
    dplyr::bind_rows(
      ...
      get_growth_curve_df(
        read.csv("20min_MMC_treatment.csv") %>%
        ...
        dplyr::mutate(Time = Time + 1/3,
                      Exposure = "20 min"),
      get_growth_curve_df(
        read.csv("60min_MMC_treatment.csv") %>%
                            rename_with(~stringr::str_replace(., "_1MMC", "_5ng_µl_MMC")) %>%
                            rename_with(~stringr::str_replace(., "_2MMC", "_10ng_µl_MMC"))
      ) %>%
        dplyr::mutate(Time = Time + 1,
                      Exposure = "60 min"),
      get_growth_curve_df(
        read.csv("2hr_MMC_treatment.csv") %>%
                            rename_with(~stringr::str_replace(., "_1MMC", "_5ng_µl_MMC")) %>%
                            rename_with(~stringr::str_replace(., "_2MMC", "_10ng_µl_MMC"))
      ) %>%
      ...
      # 2743
      get_growth_curve_df(
        read.csv("2743_20min_MMC_treatment.csv")
      ) %>%
        dplyr::mutate(Time = Time + 1/3,
                      Exposure = "20 min") %>%
        dplyr::mutate(Genotype = "08B02743"),
      get_growth_curve_df(
        read.csv("2743_60min_MMC_treatment.csv")
      ) %>%
        dplyr::mutate(Time = Time + 1,
                      Exposure = "60 min") %>%
        dplyr::mutate(Genotype = "08B02743"),
      get_growth_curve_df(
        read.csv("2743_120min_MMC_treatment.csv")
      ) %>%
        dplyr::mutate(Time = Time + 1,
                      Exposure = "120 min") %>%
        dplyr::mutate(Genotype = "08B02743"),
      # RMV4
      get_growth_curve_df(
        read.csv("RMV4_20min_MMC_treatment.csv")
      ) %>%
        dplyr::mutate(Time = Time + 1/3,
                      Exposure = "20 min") %>%
        dplyr::mutate(Genotype = "RMV4"),
      get_growth_curve_df(
        read.csv("RMV4_60min_MMC_treatment.csv")
      ) %>%
        dplyr::mutate(Time = Time + 1,
                      Exposure = "60 min") %>%
        dplyr::mutate(Genotype = "RMV4"),
      get_growth_curve_df(
        read.csv("RMV4_120min_MMC_treatment.csv")
      ) %>%
        dplyr::mutate(Time = Time + 1,
                      Exposure = "120 min") %>%
        dplyr::mutate(Genotype = "RMV4"),
      ...
      get_growth_curve_df(
        read.csv("2743_high_MMC.csv")
      ) %>%
        dplyr::mutate(Exposure = "Continuous") %>%
        dplyr::mutate(Genotype = "08B02743"),
      # High concentration, continuous exposure
      get_growth_curve_df(
        read.csv("RMV4_high_MMC.csv")
      ) %>%
        dplyr::mutate(Exposure = "Continuous") %>%
        dplyr::mutate(Genotype = "RMV4"),
      get_growth_curve_df(
        read.csv("RMV8_high_MMC.csv")
      ) %>%
        dplyr::mutate(Exposure = "Continuous") %>%
        dplyr::mutate(Genotype = "RMV8"),
      get_growth_curve_df(
        read.csv("RMV8_hybrid_high_MMC.csv")
      ) %>%
        dplyr::mutate(Exposure = "Continuous") %>%
        dplyr::mutate(Genotype = "RMV8_Znregcat")
    ) %>%
...
operator_mmc_pulse.df <-
  dplyr::bind_rows(
    dplyr::bind_rows(
      # RMV4
      get_growth_curve_df(
        read.csv("RMV4_noncoding_KO_20min_MMC_treatment.csv") %>%
      ...
      get_growth_curve_df(
        read.csv("RMV4_noncoding_KO_60min_MMC_treatment.csv") %>%
                            rename_with(~stringr::str_replace(., "_(\\d)MMC", "_MMC_replicate_\\1"))
      ) %>%
        dplyr::mutate(Time = Time + 1,
                      Exposure = "'60 min'") %>%
...
RMV4_rates_of_activation.df <-
  dplyr::bind_rows(
    dplyr::bind_rows(
      # RMV4
      get_growth_curve_df(
        read.csv("19032024_RMV4_spaL_2_20min.csv")
      ) %>%
        dplyr::mutate(Time = Time + 1/3,
                      Exposure = "20 min") %>%
        dplyr::mutate(Genotype = "RMV4_spaL"),
      get_growth_curve_df(
        read.csv("19032024_RMV4_spaL_2_60min.csv")
      ) %>%
        dplyr::mutate(Time = Time + 1,
                      Exposure = "60 min") %>%
        dplyr::mutate(Genotype = "RMV4_spaL"),
      get_growth_curve_df(
        read.csv("19032024_RMV4_spaL_2_120min.csv")
      ) %>%
        dplyr::mutate(Time = Time + 1,
                      Exposure = "120 min") %>%
        dplyr::mutate(Genotype = "RMV4_spaL"),
      ...
      get_growth_curve_df(
        read.csv("19032024_RMV4_proKO_20min.csv")
      ) %>%
        dplyr::mutate(Time = Time + 1/3,
                      Exposure = "20 min") %>%
        dplyr::mutate(Genotype = "RMV4_prophage_KO"),
      get_growth_curve_df(
        read.csv("19032024_RMV4_proKO_2_60min.csv")
      ) %>%
        dplyr::mutate(Time = Time + 1,
                      Exposure = "60 min") %>%
        dplyr::mutate(Genotype = "RMV4_prophage_KO"),
      get_growth_curve_df(
        read.csv("19032024_RMV4_proKO_120min.csv")
      ) %>%
        dplyr::mutate(Time = Time + 1,
                      Exposure = "120 min") %>%
        dplyr::mutate(Genotype = "RMV4_prophage_KO")
...
comparison_file_names<-list(
  "phiRMV8.dna.phiARI0460-2.dna.crunch",
  "phiARI0460-2.dna.phiRMV4.dna.crunch"
)
...
annotation_file_names<-list(
  "RMV8_lysogenic.embl",
  "trimmed_RMV8_immARcat_lysogeny.embl",
  "2743_lysogenic.embl",
  "RMV4_lysogenic.embl"
)

comparison_file_names<-list(
  "RMV8_lysogenic.dna.trimmed_RMV8_immARcat_lysogeny.dna.crunch",
  "trimmed_RMV8_immARcat_lysogeny.dna.2743_lysogenic.dna.crunch",
  "2743_lysogenic.dna.RMV4_lysogenic.dna.crunch"
)
output_fn<-"lysogeny_comparison.pdf"
# Names
...
ciphr_gel_image <-
  magick::image_ggplot(image_crop(image_trim((image_read_pdf("CIPHR_gel_image.pdf")))))

scRNA_pcr_df <-
  read.csv("R6x_modified_scRNA.csv") %>%
...
ggsave("prophage_transformation_Figure_1.png",
       figure_1,
       dpi = 600,
       height = 11,
       width = 8)
...
ggsave("prophage_transformation_Figure_2.png",
       figure_2,
       dpi = 600,
       height = 11,
       width = 8)
...
ggsave("prophage_transformation_Figure_3.png",
       figure_3,
       dpi = 600,
       height = 11,
       width = 8)
...
ggsave("prophage_transformation_Figure_4.png",
       figure_4,
       dpi = 600,
       height = 11,
       width = 8)
...
ggsave("prophage_transformation_Figure_5.png",
       figure_5,
       dpi = 600,
       height = 11,
       width = 8)
...
prophage_summary_plot <-
  magick::image_ggplot(image_crop(image_trim((image_read_pdf("prophage_transformation_summary_figure.pdf")))))
...
ggsave("prophage_transformation_Figure_6.png",
       figure_6,
       dpi = 600,
       height = 6,
       width = 8)
